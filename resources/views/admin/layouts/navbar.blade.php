            ...
            <ul class="nxl-navbar">
                ...
                <li class="nxl-item nxl-hasmenu nxl-trigger">
                    ...
                    <ul class="nxl-submenu">
                        <li class="nxl-item"><a class="nxl-link" href="">Danh sách nhân viên</a></li>
                        <li class="nxl-item"><a class="nxl-link" href="">Thêm mới nhân viên</a></li>
                    </ul>
                </li>
                <li class="nxl-item nxl-hasmenu nxl-trigger">
                    <a href="javascript:void(0);" class="nxl-link">
                    ...
                    <ul class="nxl-submenu">
                        <li class="nxl-item"><a class="nxl-link" href="">Danh sách khách hàng</a></li>
                        <li class="nxl-item"><a class="nxl-link" href="">Thêm mới khách hàng</a></li>
                    </ul>
                </li>
                <li class="nxl-item nxl-hasmenu nxl-trigger">
                    <a href="javascript:void(0);" class="nxl-link">
                    ...
                    <ul class="nxl-submenu">
                        <li class="nxl-item"><a class="nxl-link" href="">Danh sách danh mục</a></li>
                        <li class="nxl-item"><a class="nxl-link" href="">Thêm mới danh mục</a></li>
                    </ul>
                </li>
                <li class="nxl-item nxl-hasmenu nxl-trigger">
                    <a href="javascript:void(0);" class="nxl-link">
                    ...
                    <ul class="nxl-submenu">
                        <li class="nxl-item"><a class="nxl-link" href="">Danh sách sản phẩm</a></li>
                        <li class="nxl-item"><a class="nxl-link" href="">Thêm mới sản phẩm</a></li>
                    </ul>
                </li>
                <li class="nxl-item nxl-hasmenu nxl-trigger">
                    <a href="javascript:void(0);" class="nxl-link">
                    ...
                    <ul class="nxl-submenu">
                        <li class="nxl-item"><a class="nxl-link" href="">Danh sách đơn hàng</a></li>
                        <li class="nxl-item"><a class="nxl-link" href="">Thêm mới đơn hàng</a></li>
                    </ul>
                </li>
                <li class="nxl-item nxl-hasmenu nxl-trigger">
                    <a href="javascript:void(0);" class="nxl-link">
